...
While the aim of this tutorial is not to describe the DARTH model, readers are encouraged to read the cited texts above, it is important to have a basic understanding. The sick-sicker model contains two functions, the first, gen_psa creates a set of psa inputs, the second, f_MM_sicksicker runs the model for a specific set of PSA inputs.
